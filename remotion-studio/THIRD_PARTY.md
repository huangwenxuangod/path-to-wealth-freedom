...
- `public/logos/product-logo.png`：复制自用户已有 HyperFrames 工程，品牌参考素材，不授予第三方品牌权利。
- `public/logos/demo.svg`：本项目原创中性图标。
- `public/fonts/NotoSansSC.ttf`：Google Fonts，https://github.com/google/fonts/tree/main/ofl/notosanssc ，SIL OFL，许可在同目录 NOTO-OFL.txt。
- `public/fonts/mono.woff2`：复用旧工程的 JetBrains Mono，https://github.com/JetBrains/JetBrainsMono ，SIL OFL，许可在同目录 JETBRAINS-OFL.txt。
