...
export function Safari({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <mask id={`${uid}-safariPunch`} maskUnits="userSpaceOnUse">
            <rect
              x="0"
              y="0"
              width={SAFARI_WIDTH}
        ...
        <g
          clipPath={`url(#${uid}-path0)`}
          mask={hasMedia ? `url(#${uid}-safariPunch)` : undefined}
        >
          <path
